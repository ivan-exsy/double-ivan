...
#### PM-BFST-14 — Meet screen: schedule adapts to the town

- [ ] `double-landing-page`, Meet screen before Join, one line: “Your Double keeps your personality. Its schedule adapts to the town it lives in.” Front-end only; no backend dependency. Pairs with BE `ivan/life-not-destination` (real life is talk, not a destination).
