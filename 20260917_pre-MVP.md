...
| **PM-LTALK-7** | Showrunner waitlist door (draft) | Second-door copy: *You’re the Showrunner…* Same `b2b_group` + `group_name` capture (`sot_api.md` §10). **Draft only until you say ship.** |
