...
1. **Final script** — `script.md` + JSON with fields: `cold_open`, one `cast_overview` scene (not 15 × `cast_intro`), `stakes_montage` (mid URL + survival tease), `end_card`, `how_to_watch` (mid URL plate). **Draft v1:** `video/l-talk/script/script.json`.
2. **On-screen copy sheet** — `video/l-talk/script/on-screen-copy.md`.
...
| Material | Path | Use |
|---|---|---|
| Draft v1 script | `video/l-talk/script/script.md`, `video/l-talk/script/script.json` | Current working draft |
| Pistsov survival assets | `video/l-talk/brand/Survival.png`, `video/l-talk/brand/Pressure.mp4` | Close tease visuals (D3) |
